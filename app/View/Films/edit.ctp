...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Film.id')), array('class'=>'btn btn-round btn-primary', 'type'=>'button'), __('Are you sure you want to delete # %s?', $this->Form->value('Film.id'))); ?></li>
